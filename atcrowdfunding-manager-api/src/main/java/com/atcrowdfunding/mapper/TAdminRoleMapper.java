...
public interface TAdminRoleMapper {
    ...
    int insertMore(@Param(value = "adminId")Integer adminId, @Param(value = "roleId") Integer[] roleId);

    int deleteByadminIdAndRoleId(@Param(value = "adminId")Integer adminId, @Param(value = "roleId") Integer[] roleId);
}
